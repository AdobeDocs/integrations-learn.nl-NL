...
description: 'Leer hoe te om Adobe  [!DNL Analytics]  met de Reizen van de Klant  [!DNL Analytics]  te integreren gebruikend de 2&rbrace; bronschakelaar van de Ervaring. [!DNL Platform] '
...
# Adobe [!DNL Analytics] en Klantenreis [!DNL Analytics] integreren met de [!DNL Platform] -bronconnector
...
<ol>
    ...
    <li>De gegevens van de samenvatting in Ervaring [!DNL Platform] gebruikend de <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=nl-NL" _target="_blank" rel="noopener noreferrer"> Adobe [!DNL Analytics] bronschakelaar </a></li>
